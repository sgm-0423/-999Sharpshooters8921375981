...
// 9 个靶位（顺序 = 比赛路线顺序）
Waypoint targets[9] = {
    { 0.848785, 2.130281, 1.305787 },   // 靶1  TODO 实测：x, y, yaw
    { 0.263712, 2.571513, 2.925420 },   // 靶2  TODO 实测
    {-0.099212, 1.814008, -1.831031 },   // 靶3  TODO 实测
...
// 回程辅助点：比赛结束回到这里（起始位置附近）
Waypoint home = { 0.00, 0.00, -1.57 };   // TODO 实测
...
int main(int argc, char** argv)
{
    ...
    // 全部打完，回到回程辅助点（起始位置附近）
    ROS_INFO("===== Back to home =====");
    Move2goal(ac, home.x, home.y, home.yaw);
    ROS_INFO("All done");
